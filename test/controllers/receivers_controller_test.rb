...
class ReceiversControllerTest < ActionController::TestCase
  ...
  test "should create receiver" do
    assert_difference('Receiver.count') do
      post :create, receiver: { frequency: @receiver.frequency, haat: @receiver.haat, latitude: @receiver.latitude, location: @receiver.location, longitude: @receiver.longitude, user_id: @receiver.user_id }
    end
  ...
  test "should update receiver" do
    patch :update, id: @receiver, receiver: { frequency: @receiver.frequency, haat: @receiver.haat, latitude: @receiver.latitude, location: @receiver.location, longitude: @receiver.longitude, user_id: @receiver.user_id }
    assert_redirected_to receiver_path(assigns(:receiver))
  end
