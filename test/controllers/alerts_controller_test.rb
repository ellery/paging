...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { address: @alert.address, notes: @alert.notes, tone_set_id: @alert.tone_set_id }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { address: @alert.address, notes: @alert.notes, tone_set_id: @alert.tone_set_id }
    assert_redirected_to alert_path(assigns(:alert))
  end
