...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { address: @agency.address, city: @agency.city, phone: @agency.phone, title: @agency.title, zip: @agency.zip }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { address: @agency.address, city: @agency.city, phone: @agency.phone, title: @agency.title, zip: @agency.zip }
    assert_redirected_to agency_path(assigns(:agency))
  end
